...
class RabbitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rabbit" do
    assert_difference("Rabbit.count") do
      post rabbits_url, params: { rabbit: { description: @rabbit.description, name: @rabbit.name } }
    end
  ...
  test "should update rabbit" do
    patch rabbit_url(@rabbit), params: { rabbit: { description: @rabbit.description, name: @rabbit.name } }
